...
public class MainActivity extends Activity implements TextureView.SurfaceTextureListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (true){//(ContextCompat.checkSelfPermission(this, Manifest.permission.CAMERA) == PackageManager.PERMISSION_GRANTED) {
    ...
    private void setGreenControlListener() {
        greenThreshControl.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
            ...
            public void onProgressChanged(SeekBar seekBar, int progress, boolean fromUser) {
                progressChanged = progress;
                greenThreshTextView.setText("Kp Pos: "+ progress);
                /*
                float COM;
                COM = progress;
                String sendString = String.valueOf(COM) + '\n';
