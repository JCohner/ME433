...
void APP_Initialize(void) {
    ...
    //Initialize HBridge Control of my Baddies
    ...
    //initialize external encoder counters
    ...
    //Initialize Timer4 to be fixed time control interrupt
